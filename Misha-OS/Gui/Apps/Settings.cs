...
namespace MishaOS.Gui.Apps
{
    public class Settings:Window
    {
        ...
        public void ReDraw()
        {
            ...
            Display.disp.DrawFilledRectangle(new Pen(Color.DodgerBlue), new Cosmos.System.Graphics.Point(0, 20), width, height);//Contents
            //Draw Close Button
            ...
            //Draw Title
            Display.disp.DrawString("Settings", PCScreenFont.Default, new Pen(Color.White), new Cosmos.System.Graphics.Point(0,0));
            AddInfoText(Kernel.KernelVersion);
            AddInfoText("CPU Menufactor: "+CPU.GetCPUVendorName());
